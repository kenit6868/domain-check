...
_pages = st.navigation([
    ...
    st.Page("pages/14_Cloudflare_Form_Worker.py", title="Cloudflare Worker", icon=":material/cloud:"),
...
#     st.Page("pages/3_Brand_Scan.py",          title="Brand Scan",       icon="🛡️"),
    ...
    st.Page("pages/12_Domain_Evidence_Review.py", title="Domain Evidence Review", icon=":material/photo_library:"),
    ...
    st.Page("pages/13_General_Statistics.py", title="Thống kê tổng quát", icon=":material/analytics:"),
])
_pages.run()

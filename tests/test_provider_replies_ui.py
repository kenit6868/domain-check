...
class ProviderRepliesUiTests(unittest.TestCase):
    ...
    def test_provider_page_uses_shared_capture_state_and_exact_attachment_pair(self):
        ...
        self.assertIn('getattr(provider_replies, "MODULE_VERSION", 0) < 7', source)
        self.assertIn('"Đồng bộ Inbox + Thư rác + Cloudflare"', source)
        self.assertIn("CLOUDFLARE_MAILBOX", source)
